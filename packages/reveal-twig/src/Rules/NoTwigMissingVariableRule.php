...
final class NoTwigMissingVariableRule implements Rule
{
    ...
    public function processNode(Node $node, Scope $scope) : array
    {
        ...
        foreach ($renderTemplatesWithParameters as $renderTemplateWithParameter) {
            $missingVariableNames = \array_merge($missingVariableNames, $this->missingTwigTemplateRenderVariableResolver->resolveFromTemplateAndMethodCall($renderTemplateWithParameter, $scope));
        }
