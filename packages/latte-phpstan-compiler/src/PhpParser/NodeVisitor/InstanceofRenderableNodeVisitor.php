...
final class InstanceofRenderableNodeVisitor extends NodeVisitorAbstract implements LatteToPhpCompilerNodeVisitorInterface
{
    ...
    public function leaveNode(Node $node)
    {
        ...
        if (!$this->simpleNameResolver->isNames($instanceof->class, ['RevealPrefix20220820\\Nette\\Application\\UI\\IRenderable', 'RevealPrefix20220820\\Nette\\Application\\UI\\Renderable'])) {
            return null;
        }
