...
final class DefaultTemplateVariables implements LatteVariableCollectorInterface
{
    ...
    public function getVariablesAndTypes() : array
    {
        ...
        $variablesAndTypes[] = new VariableAndType('ʟ_fi', new ObjectType('RevealPrefix20220705\\Latte\\Runtime\\FilterInfo'));
        // nette\security bridge
        $variablesAndTypes[] = new VariableAndType('user', new ObjectType('RevealPrefix20220705\\Nette\\Security\\User'));
        // nette\application bridge
        $variablesAndTypes[] = new VariableAndType('presenter', new ObjectType('RevealPrefix20220705\\Nette\\Application\\UI\\Presenter'));
        $variablesAndTypes[] = new VariableAndType('control', new ObjectType('RevealPrefix20220705\\Nette\\Application\\UI\\Control'));
