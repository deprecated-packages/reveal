...
class Lexer
{
    ...
    protected function createTokenMap() : array
    {
        ...
        if (\defined('RevealPrefix20220713\\T_ONUMBER')) {
            $tokenMap[\RevealPrefix20220713\T_ONUMBER] = Tokens::T_DNUMBER;
        }
        // HHVM also has a separate token for the __COMPILER_HALT_OFFSET__ constant
        if (\defined('RevealPrefix20220713\\T_COMPILER_HALT_OFFSET')) {
            $tokenMap[\RevealPrefix20220713\T_COMPILER_HALT_OFFSET] = Tokens::T_STRING;
        }
