...
final class BuilderHelpers
{
    ...
    public static function normalizeIdentifier($name) : Identifier
    {
        ...
        throw new \LogicException('RevealPrefix20220711\\Expected string or instance of Node\\Identifier');
    }
    /**
    ...
    public static function normalizeIdentifierOrExpr($name)
    {
        ...
        throw new \LogicException('RevealPrefix20220711\\Expected string or instance of Node\\Identifier or Node\\Expr');
    }
    /**
    ...
    public static function normalizeName($name) : Name
    {
        ...
        throw new \LogicException('RevealPrefix20220711\\Name must be a string or an instance of Node\\Name');
    }
    /**
    ...
    public static function normalizeNameOrExpr($name)
    {
        ...
        if (!\is_string($name) && !$name instanceof Name) {
            throw new \LogicException('RevealPrefix20220711\\Name must be a string or an instance of Node\\Name or Node\\Expr');
        }
    ...
    public static function normalizeDocComment($docComment) : \PhpParser\Comment\Doc
    {
        ...
        throw new \LogicException('RevealPrefix20220711\\Doc comment must be a string or an instance of PhpParser\\Comment\\Doc');
    }
    /**
    ...
    public static function normalizeAttribute($attribute) : \PhpParser\Node\AttributeGroup
    {
        ...
        if (!$attribute instanceof \PhpParser\Node\Attribute) {
            throw new \LogicException('RevealPrefix20220711\\Attribute must be an instance of PhpParser\\Node\\Attribute or PhpParser\\Node\\AttributeGroup');
        }
