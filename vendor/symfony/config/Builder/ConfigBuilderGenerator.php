 ...
 */
namespace RevealPrefix20220707\Symfony\Component\Config\Builder;
...
use RevealPrefix20220707\Symfony\Component\Config\Definition\BooleanNode;
...
use RevealPrefix20220707\Symfony\Component\Config\Definition\Exception\InvalidConfigurationException;
use RevealPrefix20220707\Symfony\Component\Config\Definition\FloatNode;
use RevealPrefix20220707\Symfony\Component\Config\Definition\IntegerNode;
...
use RevealPrefix20220707\Symfony\Component\Config\Loader\ParamConfigurator;
/**
...
class ConfigBuilderGenerator implements ConfigBuilderGeneratorInterface
{
    ...
    public function build(ConfigurationInterface $configuration) : \Closure
    {
        ...
        $rootClass = new ClassBuilder('RevealPrefix20220707\\Symfony\\Config', $rootNode->getName());
