 ...
 */
namespace RevealPrefix20220705\Symfony\Component\DependencyInjection\Loader\Configurator;
...
class EnvConfigurator extends ParamConfigurator
{
    ...
    {
        $processor = \strtolower(\preg_replace(['/([A-Z]+)([A-Z][a-z])/', '/([a-z\\d])([A-Z])/'], 'RevealPrefix20220705\\1_\\2', $name));
