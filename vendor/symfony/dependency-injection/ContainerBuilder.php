...
use RevealPrefix20220707\Composer\InstalledVersions;
use RevealPrefix20220707\Symfony\Component\Config\Resource\ClassExistenceResource;
use RevealPrefix20220707\Symfony\Component\Config\Resource\ComposerResource;
use RevealPrefix20220707\Symfony\Component\Config\Resource\DirectoryResource;
use RevealPrefix20220707\Symfony\Component\Config\Resource\FileExistenceResource;
use RevealPrefix20220707\Symfony\Component\Config\Resource\FileResource;
use RevealPrefix20220707\Symfony\Component\Config\Resource\GlobResource;
use RevealPrefix20220707\Symfony\Component\Config\Resource\ReflectionClassResource;
use RevealPrefix20220707\Symfony\Component\Config\Resource\ResourceInterface;
...
use RevealPrefix20220707\Symfony\Component\DependencyInjection\Argument\ServiceLocator;
use RevealPrefix20220707\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument;
use RevealPrefix20220707\Symfony\Component\DependencyInjection\Attribute\Target;
use RevealPrefix20220707\Symfony\Component\DependencyInjection\Compiler\Compiler;
use RevealPrefix20220707\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;
use RevealPrefix20220707\Symfony\Component\DependencyInjection\Compiler\PassConfig;
use RevealPrefix20220707\Symfony\Component\DependencyInjection\Compiler\ResolveEnvPlaceholdersPass;
use RevealPrefix20220707\Symfony\Component\DependencyInjection\Exception\BadMethodCallException;
use RevealPrefix20220707\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException;
use RevealPrefix20220707\Symfony\Component\DependencyInjection\Exception\LogicException;
...
use RevealPrefix20220707\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\InstantiatorInterface;
use RevealPrefix20220707\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\RealServiceInstantiator;
use RevealPrefix20220707\Symfony\Component\DependencyInjection\ParameterBag\EnvPlaceholderParameterBag;
use RevealPrefix20220707\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag;
...
use RevealPrefix20220707\Symfony\Component\ExpressionLanguage\ExpressionFunctionProviderInterface;
/**
    ...
    private function doGet(string $id, int $invalidBehavior = ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE, array &$inlineServices = null, bool $isConstructorArgument = \false)
    {
        ...
        if (!isset($this->definitions[$id]) && isset($this->aliasDefinitions[$id])) {
            ...
            if ($alias->isDeprecated()) {
                ...
                \RevealPrefix20220707\trigger_deprecation($deprecation['package'], $deprecation['version'], $deprecation['message']);
            }
        ...
        if (null !== $factory) {
            ...
            if (!$definition->isDeprecated() && \is_array($factory) && \is_string($factory[0])) {
                ...
                if (0 < \strpos($r->getDocComment(), "\n * @deprecated ")) {
                    \RevealPrefix20220707\trigger_deprecation('', '', 'The "%s" service relies on the deprecated "%s" factory class. It should either be deprecated or its factory upgraded.', $id, $r->name);
                }
            }
        } else {
            ...
            if (!$definition->isDeprecated() && 0 < \strpos($r->getDocComment(), "\n * @deprecated ")) {
                \RevealPrefix20220707\trigger_deprecation('', '', 'The "%s" service relies on the deprecated "%s" class. It should either be deprecated or its implementation upgraded.', $id, $r->name);
            }
        }
