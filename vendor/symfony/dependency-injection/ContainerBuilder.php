 ...
 */
namespace RevealPrefix20220711\Symfony\Component\DependencyInjection;

use RevealPrefix20220711\Composer\InstalledVersions;
use RevealPrefix20220711\Symfony\Component\Config\Resource\ClassExistenceResource;
use RevealPrefix20220711\Symfony\Component\Config\Resource\ComposerResource;
use RevealPrefix20220711\Symfony\Component\Config\Resource\DirectoryResource;
use RevealPrefix20220711\Symfony\Component\Config\Resource\FileExistenceResource;
use RevealPrefix20220711\Symfony\Component\Config\Resource\FileResource;
use RevealPrefix20220711\Symfony\Component\Config\Resource\GlobResource;
use RevealPrefix20220711\Symfony\Component\Config\Resource\ReflectionClassResource;
...
use RevealPrefix20220711\Symfony\Component\DependencyInjection\Compiler\Compiler;
use RevealPrefix20220711\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;
use RevealPrefix20220711\Symfony\Component\DependencyInjection\Compiler\PassConfig;
use RevealPrefix20220711\Symfony\Component\DependencyInjection\Compiler\ResolveEnvPlaceholdersPass;
use RevealPrefix20220711\Symfony\Component\DependencyInjection\Exception\BadMethodCallException;
...
use RevealPrefix20220711\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException;
use RevealPrefix20220711\Symfony\Component\DependencyInjection\Extension\ExtensionInterface;
use RevealPrefix20220711\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\InstantiatorInterface;
use RevealPrefix20220711\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\RealServiceInstantiator;
use RevealPrefix20220711\Symfony\Component\DependencyInjection\ParameterBag\EnvPlaceholderParameterBag;
use RevealPrefix20220711\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag;
...
use RevealPrefix20220711\Symfony\Component\ExpressionLanguage\ExpressionFunctionProviderInterface;
/**
        ...
        if (null !== $factory) {
            ...
            if (!$definition->isDeprecated() && \is_array($factory) && \is_string($factory[0])) {
                ...
                if (0 < \strpos($r->getDocComment(), "\n * @deprecated ")) {
                    \RevealPrefix20220711\trigger_deprecation('', '', 'The "%s" service relies on the deprecated "%s" factory class. It should either be deprecated or its factory upgraded.', $id, $r->name);
                }
            }
        } else {
            ...
            if (!$definition->isDeprecated() && 0 < \strpos($r->getDocComment(), "\n * @deprecated ")) {
                \RevealPrefix20220711\trigger_deprecation('', '', 'The "%s" service relies on the deprecated "%s" class. It should either be deprecated or its implementation upgraded.', $id, $r->name);
            }
        }
