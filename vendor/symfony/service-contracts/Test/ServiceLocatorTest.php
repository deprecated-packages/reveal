 ...
 */
namespace RevealPrefix20220711\Symfony\Contracts\Service\Test;
...
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\RevealPrefix20220711\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\RevealPrefix20220711\Psr\Container\ContainerExceptionInterface::class);
