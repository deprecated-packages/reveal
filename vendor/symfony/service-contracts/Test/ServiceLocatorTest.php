 ...
 */
namespace RevealPrefix20220708\Symfony\Contracts\Service\Test;

use RevealPrefix20220708\PHPUnit\Framework\TestCase;
use RevealPrefix20220708\Psr\Container\ContainerInterface;
use RevealPrefix20220708\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\RevealPrefix20220708\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\RevealPrefix20220708\Psr\Container\ContainerExceptionInterface::class);
