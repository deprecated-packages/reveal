 ...
 */
namespace RevealPrefix20220713\Symfony\Contracts\Service\Test;
...
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\RevealPrefix20220713\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\RevealPrefix20220713\Psr\Container\ContainerExceptionInterface::class);
