...
namespace RevealPrefix20220820\Latte;
...
class Engine
{
    ...
    private function processParams($params) : array
    {
        ...
        foreach ($methods as $method) {
            if (\PHP_VERSION_ID >= 80000 && (\method_exists($method, 'getAttributes') ? $method->getAttributes(Attributes\TemplateFilter::class) : []) || \strpos((string) $method->getDocComment(), '@filter')) {
                $this->addFilter($method->name, [$params, $method->name]);
            }
            if (\PHP_VERSION_ID >= 80000 && (\method_exists($method, 'getAttributes') ? $method->getAttributes(Attributes\TemplateFunction::class) : []) || \strpos((string) $method->getDocComment(), '@function')) {
