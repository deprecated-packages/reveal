...
namespace RevealPrefix20220713\Latte\Bridges\Tracy;

use RevealPrefix20220713\Latte;
use RevealPrefix20220713\Tracy;
use RevealPrefix20220713\Tracy\BlueScreen;
use RevealPrefix20220713\Tracy\Helpers;
/**
...
class BlueScreenPanel
{
    ...
    {
        if ($e instanceof Latte\CompileException && $e->sourceName && @\is_file($e->sourceName) && (\preg_match('#Unknown tag (\\{\\w+)\\}, did you mean (\\{\\w+)\\}\\?#A', $e->getMessage(), $m) || \preg_match('#Unknown attribute (n:\\w+), did you mean (n:\\w+)\\?#A', $e->getMessage(), $m))) {
