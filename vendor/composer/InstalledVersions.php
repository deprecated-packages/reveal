 ...
 */
namespace RevealPrefix20220713\Composer;

use RevealPrefix20220713\Composer\Autoload\ClassLoader;
use RevealPrefix20220713\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('RevealPrefix20220713\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
