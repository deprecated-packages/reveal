 ...
 */
namespace RevealPrefix20220606\Composer;

use RevealPrefix20220606\Composer\Autoload\ClassLoader;
use RevealPrefix20220606\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('RevealPrefix20220606\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
