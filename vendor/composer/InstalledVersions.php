 ...
 */
namespace RevealPrefix20220708\Composer;

use RevealPrefix20220708\Composer\Autoload\ClassLoader;
use RevealPrefix20220708\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('RevealPrefix20220708\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
