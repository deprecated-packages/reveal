...
use RevealPrefix20220820\Twig\ExpressionParser;
use RevealPrefix20220820\Twig\Node\Expression\Binary\AddBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\AndBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\BitwiseAndBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\BitwiseOrBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\BitwiseXorBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\ConcatBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\DivBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\EndsWithBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\EqualBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\FloorDivBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\GreaterBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\GreaterEqualBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\InBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\LessBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\LessEqualBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\MatchesBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\ModBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\MulBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\NotEqualBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\NotInBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\OrBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\PowerBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\RangeBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\SpaceshipBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\StartsWithBinary;
use RevealPrefix20220820\Twig\Node\Expression\Binary\SubBinary;
use RevealPrefix20220820\Twig\Node\Expression\Filter\DefaultFilter;
use RevealPrefix20220820\Twig\Node\Expression\NullCoalesceExpression;
use RevealPrefix20220820\Twig\Node\Expression\Test\ConstantTest;
use RevealPrefix20220820\Twig\Node\Expression\Test\DefinedTest;
use RevealPrefix20220820\Twig\Node\Expression\Test\DivisiblebyTest;
use RevealPrefix20220820\Twig\Node\Expression\Test\EvenTest;
use RevealPrefix20220820\Twig\Node\Expression\Test\NullTest;
use RevealPrefix20220820\Twig\Node\Expression\Test\OddTest;
use RevealPrefix20220820\Twig\Node\Expression\Test\SameasTest;
use RevealPrefix20220820\Twig\Node\Expression\Unary\NegUnary;
use RevealPrefix20220820\Twig\Node\Expression\Unary\NotUnary;
use RevealPrefix20220820\Twig\Node\Expression\Unary\PosUnary;
use RevealPrefix20220820\Twig\NodeVisitor\MacroAutoImportNodeVisitor;
use RevealPrefix20220820\Twig\TokenParser\ApplyTokenParser;
use RevealPrefix20220820\Twig\TokenParser\BlockTokenParser;
use RevealPrefix20220820\Twig\TokenParser\DeprecatedTokenParser;
use RevealPrefix20220820\Twig\TokenParser\DoTokenParser;
use RevealPrefix20220820\Twig\TokenParser\EmbedTokenParser;
use RevealPrefix20220820\Twig\TokenParser\ExtendsTokenParser;
use RevealPrefix20220820\Twig\TokenParser\FlushTokenParser;
use RevealPrefix20220820\Twig\TokenParser\ForTokenParser;
use RevealPrefix20220820\Twig\TokenParser\FromTokenParser;
use RevealPrefix20220820\Twig\TokenParser\IfTokenParser;
use RevealPrefix20220820\Twig\TokenParser\ImportTokenParser;
use RevealPrefix20220820\Twig\TokenParser\IncludeTokenParser;
use RevealPrefix20220820\Twig\TokenParser\MacroTokenParser;
use RevealPrefix20220820\Twig\TokenParser\SetTokenParser;
use RevealPrefix20220820\Twig\TokenParser\UseTokenParser;
use RevealPrefix20220820\Twig\TokenParser\WithTokenParser;
use RevealPrefix20220820\Twig\TwigFilter;
use RevealPrefix20220820\Twig\TwigFunction;
use RevealPrefix20220820\Twig\TwigTest;
...
use RevealPrefix20220820\Twig\Extension\CoreExtension;
use RevealPrefix20220820\Twig\Extension\SandboxExtension;
use RevealPrefix20220820\Twig\Markup;
...
{
    return \strip_tags($string ?? '', $allowable_tags !== null && \is_array($allowable_tags) ? '<' . \implode('><', $allowable_tags) . '>' : $allowable_tags);
}
/**
...
function twig_array_filter(Environment $env, $array, $arrow)
{
    ...
    if (\is_array($array)) {
        return \array_filter($array, $arrow === null ? function ($v, $k) : bool {
            return !empty($v);
        } : $arrow, $arrow === null ? \ARRAY_FILTER_USE_BOTH : \ARRAY_FILTER_USE_BOTH);
    }
...
{
    if (!$arrow instanceof \Closure && $env->hasExtension('RevealPrefix20220820\\Twig\\Extension\\SandboxExtension') && $env->getExtension('RevealPrefix20220820\\Twig\\Extension\\SandboxExtension')->isSandboxed()) {
