...
use RevealPrefix20220713\Symplify\PackageBuilder\Exception\InvalidPrivatePropertyTypeException;
use RevealPrefix20220713\Symplify\PackageBuilder\Exception\MissingPrivatePropertyException;
/**
 * @api
