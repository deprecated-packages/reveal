...
final class NetteTypeAnalyzer
{
     ...
     */
    private const TEMPLATE_TYPES = ['RevealPrefix20220606\\Nette\\Application\\UI\\Template', 'RevealPrefix20220606\\Nette\\Application\\UI\\ITemplate', 'RevealPrefix20220606\\Nette\\Bridges\\ApplicationLatte\\Template', 'RevealPrefix20220606\\Nette\\Bridges\\ApplicationLatte\\DefaultTemplate'];
    /**
    ...
    public function isInsideComponentContainer(Scope $scope) : bool
    {
        ...
        // this type has getComponent() method
        return \is_a($className, 'RevealPrefix20220606\\Nette\\ComponentModel\\Container', \true);
    }
    public function isInsideControl(Scope $scope) : bool
    {
        ...
        return \is_a($className, 'RevealPrefix20220606\\Nette\\Application\\UI\\Control', \true);
    }
}
