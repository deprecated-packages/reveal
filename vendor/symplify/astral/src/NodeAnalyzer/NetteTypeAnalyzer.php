...
namespace RevealPrefix20220707\Symplify\Astral\NodeAnalyzer;

use RevealPrefix20220707\Nette\Application\UI\Template;
use PhpParser\Node\Expr;
use PhpParser\Node\Expr\PropertyFetch;
use PHPStan\Analyser\Scope;
use RevealPrefix20220707\Symplify\Astral\Naming\SimpleNameResolver;
use RevealPrefix20220707\Symplify\Astral\TypeAnalyzer\ContainsTypeAnalyser;
/**
 * @api
 */
final class NetteTypeAnalyzer
{
     ...
     */
    private const TEMPLATE_TYPES = ['RevealPrefix20220707\\Nette\\Application\\UI\\Template', 'RevealPrefix20220707\\Nette\\Application\\UI\\ITemplate', 'RevealPrefix20220707\\Nette\\Bridges\\ApplicationLatte\\Template', 'RevealPrefix20220707\\Nette\\Bridges\\ApplicationLatte\\DefaultTemplate'];
    /**
    ...
    public function isInsideComponentContainer(Scope $scope) : bool
    {
        ...
        // this type has getComponent() method
        return \is_a($className, 'RevealPrefix20220707\\Nette\\ComponentModel\\Container', \true);
    }
    public function isInsideControl(Scope $scope) : bool
    {
        ...
        return \is_a($className, 'RevealPrefix20220707\\Nette\\Application\\UI\\Control', \true);
    }
}
