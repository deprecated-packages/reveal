...
use RevealPrefix20220606\Symplify\ComposerJsonManipulator\ValueObject\Option;
use RevealPrefix20220606\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory;
use RevealPrefix20220606\Symplify\PackageBuilder\Parameter\ParameterProvider;
use RevealPrefix20220606\Symplify\PackageBuilder\Reflection\PrivatesCaller;
...
return static function (ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->load('RevealPrefix20220606\Symplify\\ComposerJsonManipulator\\', __DIR__ . '/../src');
