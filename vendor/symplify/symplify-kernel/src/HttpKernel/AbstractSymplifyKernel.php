...
namespace RevealPrefix20220606\Symplify\SymplifyKernel\HttpKernel;
...
use RevealPrefix20220606\Symplify\SymplifyKernel\Config\Loader\ParameterMergingLoaderFactory;
use RevealPrefix20220606\Symplify\SymplifyKernel\ContainerBuilderFactory;
use RevealPrefix20220606\Symplify\SymplifyKernel\Contract\LightKernelInterface;
use RevealPrefix20220606\Symplify\SymplifyKernel\Exception\ShouldNotHappenException;
use RevealPrefix20220606\Symplify\SymplifyKernel\ValueObject\SymplifyKernelConfig;
/**
 * @api
 */
abstract class AbstractSymplifyKernel implements LightKernelInterface
{
    ...
    public function getContainer() : \RevealPrefix20220606\Psr\Container\ContainerInterface
    {
