...
namespace RevealPrefix20220711\Symplify\AutowireArrayParameter\DependencyInjection;
...
use RevealPrefix20220711\Symplify\AutowireArrayParameter\Exception\DependencyInjection\DefinitionForTypeNotFoundException;
use Throwable;
/**
 * @api
